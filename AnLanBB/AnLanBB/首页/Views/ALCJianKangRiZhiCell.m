...
- (void)setModel:(ALMessageModel *)model {
    ...
    self.rightLB1.text = [NSString stringWithFormat:@"%@ (%@)",model.nickname,model.appointmentDate];;
    self.rightLB2.text = [NSString stringWithFormat:@"%@ (%@)",model.name,model.institutionName];;
}
