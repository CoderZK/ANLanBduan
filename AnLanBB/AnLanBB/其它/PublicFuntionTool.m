...
#pragma mark ---- 获取图片第一帧
+ (UIImage *)firstFrameWithVideoURL:(NSString *)url size:(CGSize)size
{
    ...
    AVURLAsset *urlAsset = [AVURLAsset URLAssetWithURL:[NSURL URLWithString:[url stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]]] options:opts];
