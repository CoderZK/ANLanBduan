...
- (void)setKeywords:(NSMutableArray<QYZJUserModel *> *)keywords {
    _keywords = [QYZJUserModel mj_objectArrayWithKeyValuesArray:keywords];
}

- (void)setMapBmi:(QYZJUserModel *)mapBmi {
    _mapBmi = [QYZJUserModel mj_objectWithKeyValues:mapBmi];
}

- (void)setBaseUser:(QYZJUserModel *)baseUser {
    _baseUser = [QYZJUserModel mj_objectWithKeyValues:baseUser];
}
